...
void NuevoChat(tListaChats & chats, tListaMensajes & ListaMensajes, string identificador){
	...
	chats.chats[chats.contador].receptor = ListaMensajes.mensajes[0].emisor;
	mensajeBuzon(ListaMensajes.mensajes[0], chats.chats[chats.contador].ListaMensajes.mensajes[0]);
